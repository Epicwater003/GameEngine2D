/*
* Класс  IBody это интерфейс декларирующий контракт для физики тела 
*/
...
{
public:
	//virtual IBody2D* GetBodyContract()  = 0;		   TODO: Реализовать улучшение контракта
	...
	//virtual void SetBodyContract(IBody2D cont) = 0;	 TODO: Реализовать улучшение контракта
